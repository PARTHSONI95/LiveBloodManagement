<%-- 
    Document   : rootApproveSuccessPage
    Created on : Apr 19, 2020, 4:32:00 PM
    Author     : parth
--%>
...
<html>
    ...
    <body>
        ...
        <center><mark><h1>Request has been approved</h1></mark>
        <a class="btn btn-primary" href="loginCheck.htm">Go back</a></center>
    </body>
</html>
